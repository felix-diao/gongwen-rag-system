...
class Config:
    def __init__(self):
        # 优先使用 VOLC_ASR_APP_KEY/VOLC_ASR_ACCESS_KEY，
        # 若未单独配置则回退到 VOLC_MINUTES_APP_KEY/VOLC_MINUTES_ACCESS_KEY
        ...
        self.auth = {
            ...
            "secret_key": getattr(settings, "VOLC_MINUTES_SECRET_KEY", ""),
        }

    @property
    def app_key(self) -> str:
        return self.auth.get("app_key", "")

    @property
    def access_key(self) -> str:
        return self.auth.get("access_key", "")

    @property
    def secret_key(self) -> str:
        return self.auth.get("secret_key", "")
